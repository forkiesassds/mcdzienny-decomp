            ...
            if (!(message == ""))
            {
                switch (num)
                {
                    case 1:
                    {
                        ...
                        p.level.permissionvisit = levelPermission2;
                    ...
                    case 2:
                    {
                        ...
                        if (level != null)
                        {
                            level.permissionvisit = levelPermission;
                            ...
                            {
                                Player.SendMessage(p, string.Format("visit permission changed to {0} on {1}.", text2, level.name));
                            }
                        }
                        else
                        {
